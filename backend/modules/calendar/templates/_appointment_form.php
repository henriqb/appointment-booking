                ...
                <form ng-submit=processForm() class=form-horizontal>
                    ...
                    <div class="modal-body">
                        ...
                        <div style="padding: 0 15px;">
                            ...
                            <div class=form-group>
                                ...
                                <ul class="ab-customer-list">
                                    <li ng-repeat="customer in form.customers">
                                        ...
                                        <span ng-show="customer.payment_types" ng-class="{'glyphicon ab-popover': true, 'glyphicon-credit-card': ( customer.payment_types != '' && customer.payment_types.indexOf('local') == -1 ), 'glyphicon-usd': customer.payment_types.indexOf('local') != -1}" data-content="<?php esc_attr_e( 'Payment', 'bookly' ) ?>: {{customer.payment}}"></span>
                                        <span ng-click="removeCustomer(customer)" class="glyphicon glyphicon-trash ab-pointer" title="<?php esc_attr_e( 'Remove customer', 'bookly' ) ?>"></span>
                                    </li>
                                </ul>
                            ...
                            <div class=form-group>
                                <label></label>
                                <input class="form-control" style="margin-top: 0" type="checkbox" ng-model=form.email_notification /> <?php _e( 'Send notifications', 'bookly' ) ?>
                                <?php \Bookly\Lib\Utils\Common::popover( __( 'If email or SMS notifications are enabled and you want the customer or the staff member to be notified about this appointment after saving, tick this checkbox before clicking Save.', 'bookly' ), 'width:16px;margin-left:0;' ) ?>
                            </div>
                        </div>
