...
<div id="ab_import_customers_dialog" class="modal fade" tabindex=-1 role="dialog" aria-labelledby="importCustomersModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo \Bookly\Lib\Utils\Common::escAdminUrl( \Bookly\Backend\Modules\Customers\Controller::page_slug ) ?>" method="POST">
