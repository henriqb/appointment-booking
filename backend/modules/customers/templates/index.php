        ...
        <div ng-app="customers" ng-controller="customersCtrl" class="form-horizontal ng-cloak">
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                    ...
                    <a style="margin-left: 5px" href="#ab_export_customers_dialog" class="btn btn-info pull-right" data-toggle="modal"><?php _e( 'Export to CSV', 'bookly' ) ?></a>
            ...
            <div class="table-responsive">
                <table id="ab_customers_list" class="table table-striped ab-clear" cellspacing=0 cellpadding=0 border=0>
                    <thead>
                    <tr>
                        <th style="width: 150px" ng-class=css_class.name><a href="" ng-click=reload({sort:'name'})><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_name' ) ?></a></th>
                        <th style="width: 150px" ng-class=css_class.wp_user><a href="" ng-click=reload({sort:'wp_user'})><?php _e( 'User', 'bookly' ) ?></a></th>
                        <th style="width: 100px" ng-class=css_class.phone><a href="" ng-click=reload({sort:'phone'})><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_phone' ) ?></a></th>
                        <th style="width: 250px" ng-class=css_class.email><a href="" ng-click=reload({sort:'email'})><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'ab_appearance_text_label_email' ) ?></a></th>
                    ...
                    <tr ng-repeat="customer in dataSource.customers">
                        ...
                        <td class="ab-phone" click-outside="saveCustomerPhone(customer)">
                            ...
                            <input class="form-control ab-value" ng-model=customer.phone ng-show=customer.edit_phone focus-me=customer.edit_phone <?php if ( get_option( 'ab_settings_phone_default_country' ) != 'disabled' ) : ?> intl-tel-input=customer.edit_phone intl-tel-input-id=customer.id <?php else : ?> ui-event="{blur:'saveCustomer(customer)'}" <?php endif ?> />
                        </td>
                        <td>
                ...
                <div ng-hide="dataSource.customers.length || loading">
                    <div class="alert alert-info"><?php _e( 'No customers.', 'bookly' ) ?></div>
                </div>
            </div>
            <div>
