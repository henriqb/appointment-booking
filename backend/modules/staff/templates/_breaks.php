<?php use Bookly\Backend\Modules\Staff\Forms\Widgets;
    ...
    <tr>
        ...
        <td class="breaks-list-content">
            <?php foreach ( $breaks_list as $break_interval ) : ?>
                <?php
                $formatted_start = \Bookly\Lib\Utils\DateTime::formatTime( \Bookly\Lib\Utils\DateTime::timeToSeconds( $break_interval['start_time'] ) );
                $formatted_end   = \Bookly\Lib\Utils\DateTime::formatTime( \Bookly\Lib\Utils\DateTime::timeToSeconds( $break_interval['end_time'] ) );
