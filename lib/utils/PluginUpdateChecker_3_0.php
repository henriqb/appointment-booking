...
if ( !class_exists('\Bookly\Lib\Utils\PluginUpdateChecker_3_0', false) ):
...
if ( !class_exists('\Bookly\Lib\Utils\PluginInfo_3_0', false) ):
...
if ( !class_exists('\Bookly\Lib\Utils\PluginUpdate_3_0', false) ):
...
if ( !class_exists('\Bookly\Lib\Utils\PucScheduler_3_0', false) ):
...
if ( !class_exists('\Bookly\Lib\Utils\PucUpgraderStatus_3_0', false) ):
...
if ( !class_exists('\Bookly\Lib\Utils\PucFactory', false) ):
...
PucFactory::addVersion('PluginUpdateChecker', '\Bookly\Lib\Utils\PluginUpdateChecker_3_0', '3.0');
PucFactory::addVersion('PluginUpdate', '\Bookly\Lib\Utils\PluginUpdate_3_0', '3.0');
PucFactory::addVersion('PluginInfo', '\Bookly\Lib\Utils\PluginInfo_3_0', '3.0');
